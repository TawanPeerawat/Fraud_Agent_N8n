...
if not map_df.empty:
    ...
    if map_selection and map_selection.get('selection') and map_selection['selection'].get('points'):
        ...
        if points:
            ...
            if branch_id:
                ...
                st.dataframe(
                    branch_cases[['No', 'timeInvestigation', 'fraudtype', 'fraudamount', 'severity', 'Reason Fraud']],
    ...
    st.warning("⚠️ No location data available. Check if dim_branch has latitude/longitude.")
